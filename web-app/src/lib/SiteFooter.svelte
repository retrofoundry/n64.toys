<footer class="mt-10 border-t border-edge px-6 py-6">
  <nav
    class="mx-auto flex max-w-5xl items-center justify-center gap-8 text-xs text-ink-dim"
    aria-label="Community links"
  >
    <a
      href="https://discord.gg/ur6Y8JjeyH"
      target="_blank"
      rel="noopener noreferrer"
      class="flex items-center gap-2 transition-colors hover:text-n64-blue focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-n64-blue"
    >
    ...
    <a
      href="https://github.com/retrofoundry/n64.toys"
      target="_blank"
      rel="noopener noreferrer"
      class="flex items-center gap-2 transition-colors hover:text-n64-blue focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-n64-blue"
    >
